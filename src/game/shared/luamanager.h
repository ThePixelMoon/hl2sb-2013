...
#define LUA_PATH_ENUM				LUA_ROOTPATH "/includes/enum"
#define LUA_PATH_EXTENSIONS			LUA_ROOTPATH "/includes/extensions"
#define LUA_PATH_MODULES			LUA_ROOTPATH "/includes/modules"
#define LUA_PATH_INCLUDES			LUA_ROOTPATH "/includes"
#define LUA_PATH_GAME_CLIENT		LUA_ROOTPATH "/game/client"
#define LUA_PATH_GAME_SERVER		LUA_ROOTPATH "/game/server"
#define LUA_PATH_GAME_SHARED		LUA_ROOTPATH "/game/shared"
#define LUA_PATH_EFFECTS			LUA_ROOTPATH "/effects"
#define LUA_PATH_ENTITIES			LUA_ROOTPATH "/entities"
#define LUA_PATH_GAMEUI				LUA_ROOTPATH "/gameui"
#define LUA_PATH_WEAPONS			LUA_ROOTPATH "/weapons"
